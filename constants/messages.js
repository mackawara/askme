...
const TOPUP_WAS_NOT_PROCESSED = "Sorry your topup was not processed successfully please try again by sending the word topup" 
...
const MESSAGE_NOT_FORMATTED_FOR_IMAGE_GENERATION = "Error Your message is not formatted correctly for createImage generation\n Use the example below\ncreateImage a white cloud covering a mountain";
...
const ECOCASH_NUMBER = "Which number (Ecocash) would you like to pay with";
const INVALID_ECOCASH_NUMBER = "The number you entered is not a valid Ecocash number\nplease use format shown:0771234567. *This is an example number dont send any money to it*"
const TOPUP_PRODUCT = "Which product do you want to topup\n\n1.monthly\n2.payu\n\nMonthly subscription costs RTGS$6000 (25 messages per day, for 1 month)\nPay as you use (payu) costs RTGS$500 (55 messages .Expires in 72 hours)"
const REPLY_WITH_TOPUP = "You are currently using a limited (free) version \nTo get full access subscribe by sending the word \"Topup\" \nSubscriptions start from only RTGS500"
...
const PROMPTS_VIOLATES_POLICIES = "Error:Your prompt has been rejected beacuse it violates usage policies";
